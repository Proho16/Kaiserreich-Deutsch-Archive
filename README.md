...
Diese Version wurde für Hearts of Iron IV Version 1.16.4 entwickelt.<br>
...
4. Erstelle eine Kopie der Datei `descriptor.mod`, benenne sie in `Kaiserreich-Deutsch.mod` um und verschiebe sie in den Ordner 'Hearts of Iron IV\mod'
